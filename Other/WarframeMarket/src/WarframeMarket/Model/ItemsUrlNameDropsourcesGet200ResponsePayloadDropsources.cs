...
{
    /// <summary>
    /// ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources
    /// </summary>
    [DataContract(Name = "_items__url_name__dropsources_get_200_response_payload_dropsources")]
    public partial class ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources : IEquatable<ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources" /> class.
        /// </summary>
        /// <param name="missions">missions.</param>
        /// <param name="relics">relics.</param>
        /// <param name="npc">npc.</param>
        public ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources(List<DropsourceMissionsInner> missions = default(List<DropsourceMissionsInner>), List<DropsourceRelicsInner> relics = default(List<DropsourceRelicsInner>), List<DropsourceNpcInner> npc = default(List<DropsourceNpcInner>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources {\n");
        ...
        {
            return this.Equals(input as ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources);
        }

        /// <summary>
        /// Returns true if ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemsUrlNameDropsourcesGet200ResponsePayloadDropsources input)
        {
            if (input == null)
            {
                return false;

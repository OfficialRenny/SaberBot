...
namespace WarframeMarket.Model
{
    ...
    /// OrderFull
    /// </summary>
    [DataContract(Name = "OrderFull")]
    public partial class OrderFull : IEquatable<OrderFull>, IValidatableObject
    {
        /// <summary>
        /// Defines OrderType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderFull" /> class.
        /// </summary>
        ...
        public OrderFull(string id = default(string), int platinum = default(int), int quantity = default(int), OrderTypeEnum? orderType = default(OrderTypeEnum?), PlatformEnum? platform = default(PlatformEnum?), string region = default(string), DateTime creationDate = default(DateTime), DateTime lastUpdate = default(DateTime), string subtype = default(string), bool visible = default(bool), UserShort user = default(UserShort), ItemInOrder item = default(ItemInOrder))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as OrderFull);
        }

        /// <summary>
        /// Returns true if OrderFull instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderFull input)
        {
            if (input == null)
            {
                return false;

...
namespace WarframeMarket.Model
{
    ...
    public partial class Mission : IEquatable<Mission>, IValidatableObject
    {
        /// <summary>
        ...
        public Mission(string id = default(string), string urlName = default(string), string icon = default(string), string thumb = default(string), string name = default(string))
        {
            this.Id = id;
        ...
        /// Mission name
        /// </summary>
        /// <value>Mission name</value>
        /// <example>Void Storm</example>
        ...
        {
            return this.Equals(input as Mission);
        }

        /// <summary>
        /// Returns true if Mission instances are equal
        /// </summary>
        /// <param name="input">Instance of Mission to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Mission input)
        {
            if (input == null)
            {
                return false;

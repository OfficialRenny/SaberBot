...
namespace WarframeMarket.Model
{
    ...
    /// OrderCommon
    /// </summary>
    [DataContract(Name = "OrderCommon")]
    public partial class OrderCommon : IEquatable<OrderCommon>, IValidatableObject
    {
        /// <summary>
        /// Defines OrderType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderCommon" /> class.
        /// </summary>
        ...
        public OrderCommon(string id = default(string), int platinum = default(int), int quantity = default(int), OrderTypeEnum? orderType = default(OrderTypeEnum?), PlatformEnum? platform = default(PlatformEnum?), string region = default(string), DateTime creationDate = default(DateTime), DateTime lastUpdate = default(DateTime), string subtype = default(string), bool visible = default(bool))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as OrderCommon);
        }

        /// <summary>
        /// Returns true if OrderCommon instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderCommon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderCommon input)
        {
            if (input == null)
            {
                return false;

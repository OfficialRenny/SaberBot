...
{
    /// <summary>
    /// DropsourceMissionsInner
    /// </summary>
    [DataContract(Name = "Dropsource_missions_inner")]
    public partial class DropsourceMissionsInner : IEquatable<DropsourceMissionsInner>, IValidatableObject
    {
        /// <summary>
        /// How rare item is
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DropsourceMissionsInner" /> class.
        /// </summary>
        ...
        public DropsourceMissionsInner(string missionId = default(string), string nodeId = default(string), RarityEnum? rarity = default(RarityEnum?), decimal rate = default(decimal), ItemSubtypeEnum? itemSubtype = default(ItemSubtypeEnum?), RotationEnum? rotation = default(RotationEnum?), StageEnum? stage = default(StageEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DropsourceMissionsInner {\n");
        ...
        {
            return this.Equals(input as DropsourceMissionsInner);
        }

        /// <summary>
        /// Returns true if DropsourceMissionsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DropsourceMissionsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DropsourceMissionsInner input)
        {
            if (input == null)
            {
                return false;

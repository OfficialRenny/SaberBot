...
{
    /// <summary>
    /// DropsourceRelicsInnerRate
    /// </summary>
    [DataContract(Name = "Dropsource_relics_inner_rate")]
    public partial class DropsourceRelicsInnerRate : IEquatable<DropsourceRelicsInnerRate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DropsourceRelicsInnerRate" /> class.
        /// </summary>
        ...
        public DropsourceRelicsInnerRate(decimal intact = default(decimal), decimal exceptional = default(decimal), decimal flawless = default(decimal), decimal radiant = default(decimal))
        {
            this.Intact = intact;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DropsourceRelicsInnerRate {\n");
        ...
        {
            return this.Equals(input as DropsourceRelicsInnerRate);
        }

        /// <summary>
        /// Returns true if DropsourceRelicsInnerRate instances are equal
        /// </summary>
        /// <param name="input">Instance of DropsourceRelicsInnerRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DropsourceRelicsInnerRate input)
        {
            if (input == null)
            {
                return false;

...
{
    /// <summary>
    /// DropsourceRelicsRate
    /// </summary>
    [DataContract(Name = "DropsourceRelics_rate")]
    public partial class DropsourceRelicsRate : IEquatable<DropsourceRelicsRate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DropsourceRelicsRate" /> class.
        /// </summary>
        ...
        public DropsourceRelicsRate(decimal intact = default(decimal), decimal exceptional = default(decimal), decimal flawless = default(decimal), decimal radiant = default(decimal))
        {
            this.Intact = intact;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DropsourceRelicsRate {\n");
        ...
        {
            return this.Equals(input as DropsourceRelicsRate);
        }

        /// <summary>
        /// Returns true if DropsourceRelicsRate instances are equal
        /// </summary>
        /// <param name="input">Instance of DropsourceRelicsRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DropsourceRelicsRate input)
        {
            if (input == null)
            {
                return false;

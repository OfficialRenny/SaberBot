...
namespace WarframeMarket.Model
{
    ...
    /// ItemInOrderAllOfEn
    /// </summary>
    [DataContract(Name = "ItemInOrder_allOf_en")]
    public partial class ItemInOrderAllOfEn : IEquatable<ItemInOrderAllOfEn>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemInOrderAllOfEn" /> class.
        /// </summary>
        /// <param name="itemName">Name of the item.</param>
        public ItemInOrderAllOfEn(string itemName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemInOrderAllOfEn {\n");
        ...
        {
            return this.Equals(input as ItemInOrderAllOfEn);
        }

        /// <summary>
        /// Returns true if ItemInOrderAllOfEn instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemInOrderAllOfEn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemInOrderAllOfEn input)
        {
            if (input == null)
            {
                return false;

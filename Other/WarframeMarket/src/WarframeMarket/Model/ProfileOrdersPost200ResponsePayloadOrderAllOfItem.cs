...
{
    /// <summary>
    /// ProfileOrdersPost200ResponsePayloadOrderAllOfItem
    /// </summary>
    [DataContract(Name = "_profile_orders_post_200_response_payload_order_allOf_item")]
    public partial class ProfileOrdersPost200ResponsePayloadOrderAllOfItem : IEquatable<ProfileOrdersPost200ResponsePayloadOrderAllOfItem>, IValidatableObject
    {
        /// <summary>
        /// Defines IconFormat
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProfileOrdersPost200ResponsePayloadOrderAllOfItem" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProfileOrdersPost200ResponsePayloadOrderAllOfItem {\n");
        ...
        {
            return this.Equals(input as ProfileOrdersPost200ResponsePayloadOrderAllOfItem);
        }

        /// <summary>
        /// Returns true if ProfileOrdersPost200ResponsePayloadOrderAllOfItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ProfileOrdersPost200ResponsePayloadOrderAllOfItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProfileOrdersPost200ResponsePayloadOrderAllOfItem input)
        {
            if (input == null)
            {
                return false;

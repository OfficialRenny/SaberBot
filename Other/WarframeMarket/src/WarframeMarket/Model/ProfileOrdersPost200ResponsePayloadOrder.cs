...
{
    /// <summary>
    /// ProfileOrdersPost200ResponsePayloadOrder
    /// </summary>
    [DataContract(Name = "_profile_orders_post_200_response_payload_order")]
    public partial class ProfileOrdersPost200ResponsePayloadOrder : IEquatable<ProfileOrdersPost200ResponsePayloadOrder>, IValidatableObject
    {
        /// <summary>
        /// Defines OrderType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProfileOrdersPost200ResponsePayloadOrder" /> class.
        /// </summary>
        ...
        public ProfileOrdersPost200ResponsePayloadOrder(string id = default(string), int platinum = default(int), int quantity = default(int), OrderTypeEnum? orderType = default(OrderTypeEnum?), PlatformEnum? platform = default(PlatformEnum?), string region = default(string), DateTime creationDate = default(DateTime), DateTime lastUpdate = default(DateTime), string subtype = default(string), bool visible = default(bool), ItemInOrder item = default(ItemInOrder))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProfileOrdersPost200ResponsePayloadOrder {\n");
        ...
        {
            return this.Equals(input as ProfileOrdersPost200ResponsePayloadOrder);
        }

        /// <summary>
        /// Returns true if ProfileOrdersPost200ResponsePayloadOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of ProfileOrdersPost200ResponsePayloadOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProfileOrdersPost200ResponsePayloadOrder input)
        {
            if (input == null)
            {
                return false;

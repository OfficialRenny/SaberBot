...
namespace WarframeMarket.Model
{
    ...
    /// DropsourceRelics
    /// </summary>
    [DataContract(Name = "DropsourceRelics")]
    public partial class DropsourceRelics : IEquatable<DropsourceRelics>, IValidatableObject
    {
        /// <summary>
        /// How rare item is
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DropsourceRelics" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="rarity">How rare item is.</param>
        /// <param name="rate">rate.</param>
        public DropsourceRelics(string id = default(string), RarityEnum? rarity = default(RarityEnum?), DropsourceRelicsRate rate = default(DropsourceRelicsRate))
        {
            this.Id = id;
            this.Rarity = rarity;
            this.Rate = rate;
        ...
        public DropsourceRelicsRate Rate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DropsourceRelics {\n");
        ...
        {
            return this.Equals(input as DropsourceRelics);
        }

        /// <summary>
        /// Returns true if DropsourceRelics instances are equal
        /// </summary>
        /// <param name="input">Instance of DropsourceRelics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DropsourceRelics input)
        {
            if (input == null)
            {
                return false;

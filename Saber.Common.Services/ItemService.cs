...
public class ItemService
{
    ...
    {
        return GetShopItem(new Guid(itemId));
    }

    public ShopItem? GetShopItem(Guid itemId)
    {
        return _db.ShopItems
            .Include(s => s.Item)
    ...
    {
        return ModifyShopItem(new Guid(itemId), action);
    }
    ...
    {
        return GetOwnedItem(discordId, new Guid(itemId));
    }
    ...
    {
        return GetOrCreateOwnedItem(discordId, new Guid(itemId));
    }
    ...
    {
        return ModifyOwnedItem(discordId, new Guid(itemId), action);
    }
    ...
    {
        return CreateOwnedItem(discordId, new Guid(itemId));
    }
    ...
    {
        return GetItem(new Guid(itemId));
    }
